...
bool is_name_pfx args( ( const char *str, char *namelist ) );
...
char *space_pad args( ( const char *str, short final_size ) );
...
void smash_replace args( ( char *str, char *sold, char *snew ) );
