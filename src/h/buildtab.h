...
short mon_table_lookup P_((MONITOR_TYPE *table, char *iname));
...
char *rev_mon_table_lookup P_((MONITOR_TYPE *table, short number));
...
char *bs_show_values P_((LOOKUP_TYPE *table, bitset<CFG_MEM_MAX_BITSET> &bit));
...
extern LOOKUP_TYPE tab_area_flags[];
