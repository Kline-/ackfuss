...
const struct race_type race_table[MAX_RACE] =
{
...

    {
        ...
        {TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE,
            TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE,
            TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE},
        3, {CLS_THI, CLS_MAG, CLS_CLE, CLS_WAR, CLS_PSI},
        "Thi Mag Cle War Psi",
        "steal \'pick lock\'",
        REALM_NONE,
        REALM_NONE,
...

    {
        ...
        {TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE,
            TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE,
            TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE},
        3, {CLS_CLE, CLS_PSI, CLS_MAG, CLS_THI, CLS_WAR},
        "Cle Psi Mag Thi War",
        "\'faerie fire\' sneak",
...

    {
        ...
        {TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE,
            TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE,
            TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE},
        3, {CLS_WAR, CLS_MAG, CLS_THI, CLS_CLE, CLS_PSI},
        "War Mag Thi Cle Psi",
        "\'shield block\'",
...

    {
        ...
        {TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE,
            TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE,
            TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE},
        3, {CLS_PSI, CLS_MAG, CLS_WAR, CLS_THI, CLS_CLE},
        "Psi Mag War Thi Cle",
...

    {
        ...
        3, {CLS_THI, CLS_WAR, CLS_PSI, CLS_MAG, CLS_CLE},
        "Thi War Psi Mag Cle",
        "dodge",
...

    {
        ...
        3, {CLS_MAG, CLS_CLE, CLS_WAR, CLS_PSI, CLS_THI},
        "Mag Cle War Psi Thi",
        "fly \'fire breath\'",
...

    {
        ...
        3, {CLS_WAR, CLS_CLE, CLS_THI, CLS_MAG, CLS_PSI},
        "War Cle Thi Mag Psi",
        "hunt",
...

    {
        ...
        3, {CLS_PSI, CLS_THI, CLS_MAG, CLS_CLE, CLS_WAR},
        "Psi Thi Mag Cle War",
        "fly",
...

    {
        ...
        {TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE,
            TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE,
            TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE},
        3, {CLS_WAR, CLS_MAG, CLS_CLE, CLS_PSI, CLS_THI},
        "War Mag Cle Psi Thi",
        "\'enhanced damage\'",
...

    {
        ...
        {TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE,
            ...
            TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE},
        3, {CLS_MAG, CLS_WAR, CLS_PSI, CLS_CLE, CLS_THI},
        "Mag War Psi Cle Thi",
        "fly \'stone skin\'",
...

    {
        ...
        3, {CLS_THI, CLS_WAR, CLS_MAG, CLS_PSI, CLS_CLE},
        "Thi War Mag Psi Cle",
        "fireball",
...

    {
        ...
        {TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE,
            TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE,
            TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE},
        3, {CLS_MAG, CLS_PSI, CLS_CLE, CLS_THI, CLS_WAR},
        "Mag Psi Cle Thi War",
